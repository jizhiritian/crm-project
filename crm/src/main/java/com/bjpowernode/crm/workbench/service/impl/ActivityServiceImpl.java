...
public class ActivityServiceImpl implements ActivityService {
    ...
    @Override
    public int saveEditAvtivity(Activity activity) {
    ...
    @Override
    public int saveCreateActivityByList(List<Activity> activity) {
        return activityMapper.insertAvctivityByList(activity);
    }
